		...
		<section id="home" className="flex md:flex-row flex-col paddingY ">
			<div className="flex-1 flexStart flex-col xl:px-0 sm:px-16 px-6 relative">
				...
				<div className="flex flex-row justify-between items-center w-full">
					...
					Counting<br />
						<span className="text-gradient">calories</span> <br />
					</h1>
				...
				Our cutting-edge AI technology uses advanced image recognition to accurately count and analyze your celery intake. We examine calorie content, stalk size, and overall consumption patterns.
